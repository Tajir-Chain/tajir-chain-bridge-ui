...
import { CardRedesign } from "../shared/card/card.view.redesign";
...
import { useBridgeConfirmationRedesignStyles } from "src/views/bridge-confirmation/bridge-confirmation.styles";
...
export const BridgeConfirmationRedesign: FC = () => {
 const callIfMounted = useCallIfMounted();
 const classes = useBridgeConfirmationRedesignStyles();
  ...
  <div className={classes.contentWrapper}>
   ...
   <CardRedesign className={classes.card}>
    ...
    <div className={classes.chainsRow}>
     ...
     </div><img className={classes.arrowIcon} src='src/assets/icons/arrow-right.svg' />
     <div className={classes.chainBox}>
      <to.Icon />
      <Typography className={classes.chainName} type="body1">
       {to.name}
