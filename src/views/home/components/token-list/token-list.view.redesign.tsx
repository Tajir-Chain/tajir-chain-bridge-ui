...
import { useTokenListRedesignStyles } from "src/views/home/components/token-list/token-list.styles";
...
export const TokenListRedesign: FC<TokenListProps> = ({
  account,
  chains,
  onClose,
  ...
  const classes = useTokenListRedesignStyles();
  ...
  return (
    <div className={classes.tokenList}>
      <TokenSelectorHeaderRedesign onClose={onClose} title="Select token" />
